...
# 下载最新股票数据
python3 ~/Documents/sh/stock/py_share_download_company.py "$ARG1" "$ARG2"
...
# 上涨概率
python3 ~/Documents/sh/stock/py_rise.py

# 今天3倍成交，未涨停
python3 ~/Documents/sh/stock/py_hvlr.py

# cyc
python3 ~/Documents/sh/stock/py_cyc.py
