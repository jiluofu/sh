...
for stock_code in stock_codes:
    ...
    price_mean = round(predicted_price, 3)
...
with open("top_20_stocks_xgboost.txt", "w", encoding="utf-8") as f:
    for stock in top_20_stocks:
        f.write(stock + "\n")

print("✅ 预测结果已保存到 predicted_prices_xgboost.csv，并按预测比昨日收盘增长%排序")
print("✅ 前20个股票代码已保存到 top_20_stocks_xgboost.txt")