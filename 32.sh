...
cp -rf /Volumes/32/DCIM/100MSDCF/*.ARW $pic_dir/$ls_date
cp -rf /Volumes/32/DCIM/101MSDCF/*.ARW $pic_dir/$ls_date

# video_dir="/Users/zhuxu/Desktop/mmjswork/video"
# rm -rf video_dir/*
# cp -rf /Volumes/32/PRIVATE/M4ROOT/CLIP/*.MP4 $video_dir

video_dir="/Users/zhuxu/Pictures/lr/videos"
mkdir $video_dir/$ls_date
cp -rf /Volumes/32/PRIVATE/M4ROOT/CLIP/*.MP4 $video_dir/$ls_date